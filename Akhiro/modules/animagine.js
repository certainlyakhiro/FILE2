...
module.exports = {
  metadata: {
    ...
    usage: "{p}imagine [prompt] | [model]"
  },
  onRun: async function ({ box, event, args, api }) {
    ...
    try {
      ...
      if (event.type === "message_reply") {
        ...
        if (!attachment || !["photo", "sticker"].includes(attachment.type)) {
          return box.reply("ayo reply to an image");
        }
        ...
        return box.reply("Please reply to an image or provide vaild prompt.");
      }
